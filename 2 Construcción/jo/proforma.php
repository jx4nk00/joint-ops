<?php 
	...
	$referenciaCliente= $Liquidacion->getReferenciaClinete($idDeProyecto);
						...
						<div class="box-content">
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<p class="pull-right">Fecha: OCTUBRE 01, 2012</p>
								</div>
							</div>
								...
								<thead>
							 	...
							 	<tbody>
									<tr>
										...
										<td>Diario</td>
										<td>
											<span id="valorDolar"><?php echo $valorDolar ?></span> 
										</td>
										<td>
											<input id="cantidadHTD" name="cantidadHTD" type="text" class="input-small" placeholder="HTD" />
										</td>
										<td>
											$<span id="totalHonorario">0</span>.-
									...
									<tr>
										<td colspan="8">
											<span class="pull-left">
												<a href="#" class="btn btn-success"><i class="icon-plus-sign icon-white"></i> Agregar Fila</a>
												<a href="#" class="btn btn-danger"><i class="icon-minus-sign icon-white"></i> Quitar última fila</a>
											</span>
